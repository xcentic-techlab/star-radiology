    ...
    <>
      <Helmet>
        ...
        <meta
          ...
          content="Star Radiology & Diagnostics Centre"
        />
          ...
          <div className="container mx-auto px-4 sm:px-6">
            ...
            >
              ...
              <p className="mt-3 sm:mt-5 text-sm sm:text-base text-slate-600 leading-relaxed">
                Contact Star Radiology & Diagnostics Centre in Noida for CT Scan,
                X-Ray, Ultrasound & pathology services. Call or visit a diagnostic
                centre near me.
              </p>
            </motion.div>
